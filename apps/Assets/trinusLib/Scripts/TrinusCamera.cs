...
namespace trinus{
	public class TrinusCamera : MonoBehaviour
	{
	    ...
	    public Camera UICamera, UICameraChild;
...
//		public float defaultViewAngle = 0;
		...
		void Awake(){
		    ...
		    uiCameraMain = UICamera;// GameObject.Find ("TrinusUICamera").GetComponent<Camera>();
		    uiCameraSub = UICameraChild;//uiCameraMain.transform.Find ("Camera").GetComponent<Camera> ();
