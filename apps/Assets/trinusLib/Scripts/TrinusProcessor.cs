...
namespace trinus{
	...
	public class TrinusProcessor : MonoBehaviour {
	    ...
	    public RenderTexture RenderTexFromCams;
...
//		Vector3 offset;
	...
	//	public string forcedIp = null;
		...
		public bool pauseWhileConnecting = false;
...
//						}
					        ...
					        //Debug.Log(oldRendTex.name);
                        RenderTexture.active = RenderTexFromCams;
					        //Debug.Log(RenderTexFromCams.name);
                        var cams = trinusCamera.getMainDualCamera();
